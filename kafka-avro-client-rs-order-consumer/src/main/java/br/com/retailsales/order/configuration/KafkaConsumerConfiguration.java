package br.com.retailsales.order.configuration;
...
public class KafkaConsumerConfiguration {
	...
	public ConcurrentKafkaListenerContainerFactory<String, AvroOrder> kafkaListenerContainerFactory() {
		...
		ConcurrentKafkaListenerContainerFactory<String, AvroOrder> listener = new ConcurrentKafkaListenerContainerFactory<>();
