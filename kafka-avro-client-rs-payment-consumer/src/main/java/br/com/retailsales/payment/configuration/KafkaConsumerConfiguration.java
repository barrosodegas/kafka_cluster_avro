package br.com.retailsales.payment.configuration;
...
public class KafkaConsumerConfiguration {
	 ...
	 */
	@Bean
	public ConsumerFactory<String, AvroPayment> consumerFactory() {
	 ...
	 */
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, AvroPayment> kafkaListenerContainerFactory() {
		
		ConcurrentKafkaListenerContainerFactory<String, AvroPayment> listener = new ConcurrentKafkaListenerContainerFactory<>();
